...
export default () => (
  <>
    ...
    <Paragraph>
      ...
      statistics and computer science and a <strong>Master’s degree</strong> in
      multimedia. During my studies, I have interned at four different companies
      in France, Luxembourg and South Korea. I am really used to work in a
    ...
    <Paragraph>
      ...
      agencies. I initially joined Netwise for eight months and then I worked at
      Cream for roughly one year. I've made web applications and responsive
    ...
    <Paragraph>
      ...
      worked on web views that summarize your Club progression visible from the
      main menu of Assassin's Creed Origins and Odyssey.
    </Paragraph>
    <Paragraph>
